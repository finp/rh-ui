...
[abstract]
From the *Data Bucket* menu, information and statistics about buckets and nodes is displayed for the entire rh Server cluster.
The information is aggregated from all the server nodes within the configured cluster for the selected bucket.

From the menu:rh Web Console[Buckets] menu, click the menu:Statistics[] link for each bucket.
...
Bucket monitoring within the rh Web Console has been updated to show additional detailed information.
...
All views within rh operate as follows:
...
=== rh Kafka Connector 3.2.3 GA (2018-02-20)

Options are "DISABLED", "ENABLED", and "FORCED".

Issues resolved in this release:

* https://issues.rh.com/browse/KAFKAC-89[KAFKAC-89]: [ENHANCEMENT] Enable NOOP for dead connection detection (Patrik Nordebo)
* https://issues.rh.com/browse/KAFKAC-82[KAFKAC-82]: [FEATURE] Implement log redaction for Kafka Connector
* https://issues.rh.com/browse/KAFKAC-90[KAFKAC-90]: [FEATURE] Source: Add config settings to enable compression

[source,xml]
----
<dependency>
    <groupId>com.rh.client</groupId>
    <artifactId>kafka-connect-rh</artifactId>
    <version>3.2.3</version>
</dependency>
----

http://packages.rh.com/clients/kafka/3.2.3/kafka-connect-rh-3.2.3.zip[kafka-connect-rh-3.2.3.zip]
